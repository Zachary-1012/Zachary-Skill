/**
 * Fingerprint data constants for the Xiaohongshu web signer.
 *
 * Vendored under the MIT License from:
 *   lucasygu/redbook  (MIT, Copyright (c) 2026 Lucas Gu)
 *   https://github.com/lucasygu/redbook/blob/main/src/lib/fingerprint-data.ts
 * itself ported from Cloxl/xhshow (MIT, Copyright (c) 2024 Cloxl).
 * See NOTICE for full attribution. Magic constants are kept verbatim so the
 * generated browser fingerprint stays consistent with the web client.
 */
