...
assert.equal(skill.productVersion, "2.0.2");
...
assert.match(index, /experience-v2\.css\?v=2\.0\.2/);
...
assert.deepEqual(manifest.professionalIntelligence.primaryNavigation, ["studio", "library", "calendar", "research", "discover", "watch", "settings"]);
