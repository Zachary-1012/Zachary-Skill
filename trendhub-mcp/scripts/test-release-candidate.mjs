...
assert.equal(professional.stableBase, "1.7.3");
assert.equal(professional.targetStableVersion, "1.7.4");
assert.equal(professional.expectedToolCount, 21);
assert.equal(professional.candidateVersion, "1.7.4");
assert.equal(pkg.version, "1.7.4");
assert.notEqual(professional.targetStableVersion, "1.4.5");
const dry = buildPromotionPlan("1.7.4", { dryRun: true });
...
for (const doc of ["RELEASE_CANDIDATE.md", "V1_6_0_AGENT_NATIVE_FOUNDATION.md", "V1_7_0_INTELLIGENCE_WORKSPACE.md"]) {
