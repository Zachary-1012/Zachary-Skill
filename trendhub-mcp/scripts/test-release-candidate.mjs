...
if (professional.releaseStatus === "release-ready") assert.equal(pkg.version, "1.5.0");
...
console.log(`RELEASE CONTRACT TEST OK status=${professional.releaseStatus} promotion=dry-run tools=21 stable-base=v1.4.4`);
